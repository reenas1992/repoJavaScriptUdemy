...
// Ternary Operator
intAge >= 18
  ? console.log(strFirstName + " drink Beer. ")
  : console.log(strFirstName + " drink Juice. ");
var drink = intAge >= 18 ? "Beer" : "Juice";
console.log(drink);
...
switch (strJob) {
  case "Doctor":
    console.log(strFirstName + " take care of patient. ");
    break;
  case "Teacher":
    console.log(strFirstName + " teaches kids how to code. ");
    break;
  case "Designer":
    console.log(strFirstName + " designs beautifull website. ");
    break;
  default:
    console.log(strFirstName + " does something else. ");
}
...
switch (true) {
  case intAge < 13:
    console.log(strFirstName + " is a girl. ");
    break;
  case intAge >= 13 && intAge < 30:
    console.log(strFirstName + " is a teenager. ");
    break;
  case intAge >= 30 && intAge < 40:
    console.log(strFirstName + "is a young girl. ");
    break;
  default:
    console.log(strFirstName + " is a woman. ");
